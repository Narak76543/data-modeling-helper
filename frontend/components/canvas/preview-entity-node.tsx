...
export function PreviewEntityNodeComponent({
  ...
  return (
    <div
      ...
      className={`min-w-[260px] max-w-[340px] bg-surface text-ink border-2 border-dashed border-accent rounded-[3px] transition-all duration-150 select-none ${
        isDimmed
          ? "opacity-25"
          : isHighlighted
          ? "ring-2 ring-accent shadow-md opacity-100"
          : selected
          ? "ring-2 ring-accent/40 shadow-sm"
          : ""
      }`}
    >
      ...
      {/* AI Preview Banner */}
      <div className="px-2.5 py-1 bg-accent/10 border-b border-accent/20 flex items-center justify-between text-[11px] font-mono text-accent">
      ...
      {/* Header: Entity Name */}
      <div className={`flex items-center justify-between px-2.5 py-2 bg-surface ${!isCollapsed ? "border-b border-ink/10" : ""}`}>
